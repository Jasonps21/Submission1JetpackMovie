...
class FakeMovieRepository(private val remoteDataSource: RemoteDataSource, private val localDataSource: LocalDataSource,
...
//    override fun getMovieWithActors(movieId: Int): LiveData<Resource<MovieWithActor>> {
//        return object : NetworkBoundResource<MovieWithActor, List<ActorResponse>>(appExecutors) {
//            override fun loadFromDB(): LiveData<MovieWithActor> =
//                localDataSource.getMovieWithActors(movieId)
//
//            override fun shouldFetch(data: MovieWithActor?): Boolean =
//                data?.mActor == null || data.mActor.isEmpty()
//
